...
export interface ShipCountsFields {
...
export interface ShipCountsJSON {
  /** The total number of ships in the fleet. */
  total: number
  /**
   * Used when updating a fleet.
...
export class ShipCounts {
  ...
  constructor(fields: ShipCountsFields) {
  ...
  static toEncodable(fields: ShipCountsFields) {
    return {
      total: fields.total,
  ...
  static fromJSON(obj: ShipCountsJSON): ShipCounts {
    return new ShipCounts({
      total: obj.total,
      updated: obj.updated,
      xxSmall: obj.xxSmall,
  ...
  toEncodable() {
    return ShipCounts.toEncodable(this)
  }
}
