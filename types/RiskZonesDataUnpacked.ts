...
export interface RiskZonesDataUnpackedFields {
  /** Mud security zone */
...
export interface RiskZonesDataUnpackedJSON {
  /** Mud security zone */
...
export class RiskZonesDataUnpacked {
  /** Mud security zone */
  ...
  constructor(fields: RiskZonesDataUnpackedFields) {
  ...
  static fromDecoded(obj: any) {
    return new RiskZonesDataUnpacked({
  ...
  static toEncodable(fields: RiskZonesDataUnpackedFields) {
    return {
  ...
  toJSON(): RiskZonesDataUnpackedJSON {
    return {
  ...
  static fromJSON(obj: RiskZonesDataUnpackedJSON): RiskZonesDataUnpacked {
    return new RiskZonesDataUnpacked({
  ...
  toEncodable() {
    return RiskZonesDataUnpacked.toEncodable(this)
  }
}
