...
export interface RemoveInvalidShipEscrowArgs {
  input: types.RemoveShipEscrowInputFields
}

export interface RemoveInvalidShipEscrowAccounts {
...
export function removeInvalidShipEscrow(
  args: RemoveInvalidShipEscrowArgs,
  accounts: RemoveInvalidShipEscrowAccounts,
  ...
  const identifier = Buffer.from([248, 15, 16, 197, 13, 248, 39, 0])
