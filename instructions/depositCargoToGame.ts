...
export interface DepositCargoToGameArgs {
  input: types.CargoToGameInputFields
}

export interface DepositCargoToGameAccounts {
...
export function depositCargoToGame(
  args: DepositCargoToGameArgs,
  accounts: DepositCargoToGameAccounts,
  ...
  const identifier = Buffer.from([87, 49, 117, 148, 241, 247, 176, 18])
